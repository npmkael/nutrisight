...
const foodItems: FoodItem[] = [
  { id: "1", name: "Grilled Chicken Salad", calories: 450, weight: 300 },
  { id: "2", name: "Caesar Wrap", calories: 380, weight: 250 },
  { id: "3", name: "Quinoa Bowl", calories: 420, weight: 280 },
  { id: "4", name: "Turkey Sandwich", calories: 320, weight: 200 },
  { id: "5", name: "Vegetable Soup", calories: 180, weight: 350 },
  { id: "6", name: "Pasta Salad", calories: 290, weight: 220 },
  { id: "7", name: "Fish Tacos", calories: 340, weight: 180 },
];
      ...
      <View className="bg-white">
        ...
        <View className="flex-row items-center justify-between px-5 py-5">
          ...
          <View className="relative">
            ...
            {/* Dropdown Menu */}
            {showDropdown && (
              <Animated.View className="absolute top-8 left-1/2 -translate-x-1/2  bg-white border border-gray-200 rounded-lg shadow-lg z-10 w-[100px]">
...
export default memo(LunchScreen);
