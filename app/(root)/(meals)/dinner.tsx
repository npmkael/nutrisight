...
const foodItems: FoodItem[] = [
  { id: "1", name: "Salmon with Quinoa", calories: 520, weight: 300 },
  { id: "2", name: "Beef Stir Fry", calories: 480, weight: 280 },
  { id: "3", name: "Chicken Curry", calories: 420, weight: 350 },
  { id: "4", name: "Vegetable Lasagna", calories: 380, weight: 250 },
  { id: "5", name: "Grilled Steak", calories: 550, weight: 200 },
  { id: "6", name: "Shrimp Pasta", calories: 450, weight: 300 },
  { id: "7", name: "Roast Chicken", calories: 390, weight: 220 },
];
      ...
      <View className="bg-white">
        ...
        <View className="flex-row items-center justify-between px-5 py-5">
          ...
          <View className="relative">
            ...
            {/* Dropdown Menu */}
            {showDropdown && (
              <Animated.View className="absolute top-8 w-[100px] left-1/2 -translate-x-1/2 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
...
export default memo(DinnerScreen);
