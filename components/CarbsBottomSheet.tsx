...
interface CarbsBottomSheetProps {
...
function CarbsBottomSheet({
  bottomSheetRef,
  currentValue,
  onSave,
  onClose,
}: CarbsBottomSheetProps) {
  ...
  const handleIncrement = useCallback(() => {
    ...
    const newValue = Math.min(currentNum + 10, 500);
...
export default memo(CarbsBottomSheet);
